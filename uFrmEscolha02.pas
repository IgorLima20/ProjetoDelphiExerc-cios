  ...
  try
   ...
   case codigo of
     100: begin
          ...
          mens := 'O seu pedido é ' + IntToStr(quantidade) + ' Cachorro-quente' +
     ...
     101: begin
          valor := 6.50;
          final := valor * quantidade;
          mens := 'O seu pedido é ' + IntToStr(quantidade) + ' Bauru Simples' +
                   ' no valor de: R$' + FormatFloat('#0.00', final);
     end;
     ...
     102: begin
          valor := 7.50;
          final := valor * quantidade;
          mens := 'O seu pedido é ' + IntToStr(quantidade) + ' Bauru com ovo' +
                   ' no valor de: R$' + FormatFloat('#0.00', final);
     end;
     ...
     103: begin
          valor := 6.00;
          final := valor * quantidade;
          mens := 'O seu pedido é ' + IntToStr(quantidade) + ' Hambúrguer' +
                   ' no valor de: R$' + FormatFloat('#0.00', final);
     end;
     ...
     104: begin
          valor := 6.30;
          final := valor * quantidade;
          mens := 'O seu pedido é ' + IntToStr(quantidade) + ' Cheeseburguer' +
                   ' no valor de: R$' + FormatFloat('#0.00', final);
     end;
     ...
     105: begin
          valor := 5.00;
          final := valor * quantidade;
          mens := 'O seu pedido é ' + IntToStr(quantidade) + ' Refrigerante' +
                   ' no valor de: R$' + FormatFloat('#0.00', final);
     end;
   end;
