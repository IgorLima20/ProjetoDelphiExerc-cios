...
begin
  try
   ...
   case data of
     0..4: mens:= 'Idade indisponível';
     5..7: mens:= 'Sua categoria é infantil A';
     8..10: mens:= 'Sua categoria é infantil B';
     11..13: mens:= 'Sua categoria é juvenil A';
     14..17: mens:= 'Sua categoria é juvenil B';
     else
     mens := 'Sua categoria é adulto';
   end;
