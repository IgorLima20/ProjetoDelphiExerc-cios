...
begin
  try
   ...
   case Round(saldo) of
     0..200: mens:= 'O seu saldo médio é de: R$' + FormatFloat('#0.00', saldo) +
             ' você não tem direito a crédito';
     201..400: begin
       final := (20*saldo)/100;
       mens := 'O seu saldo médio é de: R$' + FormatFloat('#0.00', saldo) +
        ' e o seu valor do crédito é de: R$' + FormatFloat('#0.00', final);
     end;
     401..600: begin
       final := (30*saldo)/100;
       mens := 'O seu saldo médio é de: R$' + FormatFloat('#0.00', saldo) +
