...
uses
  ...
  uFrmOpMat04 in 'uFrmOpMat04.pas' {frmOpMat04},
  uFrmOpMat05 in 'uFrmOpMat05.pas' {frmOpMat05},
  uFrmOpMat06 in 'uFrmOpMat06.pas' {frmOpMat06},
  uFrmSep01 in 'uFrmSep01.pas' {frmSep01},
  uFrmSep02 in 'uFrmSep02.pas' {frmSep02},
  uFrmSep03 in 'uFrmSep03.pas' {frmSep03},
  uFrmSep04 in 'uFrmSep04.pas' {frmSep04},
  ...
  uFrmEscolha04 in 'uFrmEscolha04.pas' {frmEscolha04},
  ...
  uFrmPara04 in 'uFrmPara04.pas' {frmPara04},
  uFrmEnquanto04 in 'uFrmEnquanto04.pas' {frmEnquanto04},
  uFrmRepita04 in 'uFrmRepita04.pas' {frmRepita04};
...
begin
  ...
  Application.CreateForm(TfrmOpMat04, frmOpMat04);
  Application.CreateForm(TfrmOpMat05, frmOpMat05);
  Application.CreateForm(TfrmOpMat06, frmOpMat06);
  Application.CreateForm(TfrmSep01, frmSep01);
  Application.CreateForm(TfrmSep02, frmSep02);
  Application.CreateForm(TfrmSep03, frmSep03);
  Application.CreateForm(TfrmSep04, frmSep04);
  ...
  Application.CreateForm(TfrmEscolha04, frmEscolha04);
  ...
  Application.CreateForm(TfrmPara04, frmPara04);
  Application.CreateForm(TfrmEnquanto04, frmEnquanto04);
  Application.CreateForm(TfrmRepita04, frmRepita04);
  Application.Run;
end.
